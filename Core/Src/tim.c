...
void HAL_TIM_Encoder_MspInit(TIM_HandleTypeDef* tim_encoderHandle)
{
  ...
  /* USER CODE END TIM1_MspInit 0 */
    ...
    PE11     ------> TIM1_CH2
    */
    GPIO_InitStruct.Pin = Enconder1A_Pin|Enconder1B_Pin;
  ...
  /* USER CODE END TIM3_MspInit 0 */
    ...
    PB5     ------> TIM3_CH2
    */
    GPIO_InitStruct.Pin = Enconder3A_Pin|Enconder3B_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /* USER CODE END TIM4_MspInit 0 */
    ...
    PD13     ------> TIM4_CH2
    */
    GPIO_InitStruct.Pin = Enconder4A_Pin|Enconder4B_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* tim_encoderHandle)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PE11     ------> TIM1_CH2
    */
    HAL_GPIO_DeInit(GPIOE, Enconder1A_Pin|Enconder1B_Pin);
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PB5     ------> TIM3_CH2
    */
    HAL_GPIO_DeInit(GPIOB, Enconder3A_Pin|Enconder3B_Pin);
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PD13     ------> TIM4_CH2
    */
    HAL_GPIO_DeInit(GPIOD, Enconder4A_Pin|Enconder4B_Pin);
